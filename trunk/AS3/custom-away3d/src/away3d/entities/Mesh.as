package away3d.entities
{
	...
	public class Mesh extends Entity implements IMaterialOwner, IAsset
	{
		...
		public function subMeshFromName(name : String) : SubMesh
		{
			var index:int = subMeshIndexFromName(name);
		...
		public function subMeshIndexFromName(name : String) : int
		{
			for(var i : int = 0; i < _subMeshes.length; ++i)
			{
				if (_subMeshes[i].name === name)
					return i;
			}
