package away3d.animators
{
	...
	public class SmoothSkeletonAnimator extends SkeletonAnimatorBase
	{
		...
		public function get lerpNode():SkeletonNaryLERPNode
		{
			return _lerpNode;
		}
		
		public function playSequence(sequenceName : String, crossFadeTime : Number = 0) : void
		{
		...
		{
			playSequence(sequenceName, crossFadeTime);
			start();
		}
		 ...
		 * @private
		 */
		override public function updateAnimation(realDT : Number, scaledDT : Number) : void
		{
