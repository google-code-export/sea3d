package away3d.filters
{
	...
	public class BloomFilter3D extends Filter3DBase
	{
		...
		public function BloomFilter3D(blurX : uint = 15, blurY : uint = 15, threshold : Number = .75, exposure : Number = 3, quality : int = 3, blendMode:String="lighten")
		{
			super();
			_brightPassTask = new Filter3DBrightPassTask(threshold);
			_blurTask = new Filter3DBlurTask(blurX, blurY);
		   	_compositeTask = new Filter3DCompositeTask(blendMode, exposure);
		...
		{
			_compositeTask.blendMode = value;	
		}
		
		public function get blendMode():String
		{
			return _compositeTask.blendMode;
		}
