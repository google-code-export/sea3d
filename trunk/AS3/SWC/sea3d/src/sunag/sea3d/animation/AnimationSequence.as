...
package sunag.sea3d.animation
{
	...
	public class AnimationSequence
	{
		private static const _libType:Array = (function():Array
		{
			...
			data[InterpolationType.LINEAR_ROUND] = MathHelper.interpolation;
			data[InterpolationType.LINEAR_EULER] = MathHelper.interpolationEuler;
			return data;
		})();
		...
		public function AnimationSequence(frameRate:int=30, count:int=0, data:*=0, key:int=-1, type:uint=0)
		{						
			this.key = key;
			this.type = type;
		...
		{
			return new AnimationSequence(frameRate, count, data, key, type);
		}
	}
}