package away3d.core.base
{
	...
	public class SubGeometry extends SubGeometryBase implements ISubGeometry
	{
		...
		public function activateSecondaryUVBuffer(index : int, stage3DProxy : Stage3DProxy) : void
		{
			...
			context.setVertexBufferAt(index, 
				_secondaryUvs ? _secondaryUvBuffer[contextIndex] : _uvBuffer[contextIndex], 
		...
		public function updateUVData(uvs : Vector.<Number>) : void
		{
			...
			_uvsDirty = _autoGenerateUVs = (uvs == null);			
			_uvs = uvs;
			invalidateBuffers(_uvsInvalid);
		}
		...
		{			 
			 _vertexNormalsDirty = _autoDeriveVertexNormals = (vertexNormals == null);
			_vertexNormals = vertexNormals;
			invalidateBuffers(_normalsInvalid);
		}
		...
		{			 
			 _vertexTangentsDirty = _autoDeriveVertexTangents = (vertexTangents == null);
			_vertexTangents = vertexTangents;
			invalidateBuffers(_tangentsInvalid);
		}
		
		public function fromVectors(verts : Vector.<Number>, uvs : Vector.<Number>=null, normals : Vector.<Number>=null, tangents : Vector.<Number>=null, uvs2 : Vector.<Number>=null) : void
		{
