package away3d.materials
{
	 ...
	 */
	public class SinglePassMaterialBase extends MaterialBase implements IPassMaterial
	{
		arcane var _screenPass : SuperShaderPass;
		...
		*/
		...
		public function getMethodByClass(clazz:Class) : EffectMethodBase
		{
			for (var i:int = 0; i < numMethods; i++)
			{
				if (getMethodAt( i ) is clazz)
				{
